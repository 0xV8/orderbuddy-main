...
import { add, addOutline, createOutline, fastFood } from 'ionicons/icons';
                ...
                <IonCard key={item.id} className='menu-item-card'>
                  <IonGrid className='ion-no-padding'>
                    <IonRow className='ion-align-items-center '>
                      <IonCol size='1' style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                        {item.imageUrls?.[0] ? (
                          <>
                            <img
                            ...
                            <IonIcon
                              icon={fastFood}
                              style={{ fontSize: '48px', color: '#999', display: 'none' }}
                              className={!item.isAvailable ? 'greyed-out' : ''}
                            />
                          </>
                        ) : (
                          <IonIcon

...
const MenuItemModal: React.FC<MenuItemModalProps> = ({ selectedItem, onClose, isOpen, addOrderItem }) => {
  ...
  const [orderItem, setOrderItemState] = useState<OrderItem>(initialOrderState);
    ...
    >
      ...
      <IonContent className='ion-padding'>
        <div className='menu-item-modal-content'>
          <div className='item-image-container' style={{ width: '100%', height: '250px', overflow: 'hidden' }}>
            <img
          ...
          {selectedItem.variants && selectedItem.variants.length > 0 && (
            <div className='variants-section ion-padding-top'>
              <IonSegment
          ...
          {selectedItem.modifiers && selectedItem.modifiers.length > 0 && (
            <div className='modifiers-section ion-padding-top'>
